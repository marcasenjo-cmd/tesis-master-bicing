...
def merge_neighborhood_table_robust(stations: gpd.GeoDataFrame, csv_name: str) -> gpd.GeoDataFrame:
    ...
    value_cols = [c for c in df.columns if c not in [nb_col, "neighborhood_key"]]
...
def main():
    ...
    # Diagnóstico rápido de cobertura socioeconómica
    socio_cols = [
    ...
    # quita claves técnicas del output final
