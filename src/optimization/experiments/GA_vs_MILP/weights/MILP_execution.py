...
from src.optimization.experiments.GA_vs_MILP_paired_ttest.MILP_algorithm import process_one_weight_combination
...
def run_all_milp_experiments(df, N_STATIONS, weight_combinations, experiment_dir, experiments_output_file):
    """
...
if __name__ == "__main__":
    ...
    experiments_output_file = f"{experiment_dir}/MILP_scores_in_weights_experiment.csv"

    # Run optimization
    run_all_milp_experiments(df, N_STATIONS, weight_combinations, experiment_dir, experiments_output_file)
