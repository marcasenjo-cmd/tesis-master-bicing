...
if __name__ == "__main__":
    ...
    score_combination = 'exponential'  # Options: 'multiply', 'exponential', 'power_penalty'
    penalty_power = None  # Higher power for more severe penalties
    
    # Create results directory
    RESULTS_DIR = f"{PR_EXP}/GA_alpha_screening/var_exploration/"
    ...
    # target_vars = ['population', 'tram_lines', 'bus_lines', 'bike_lane_kms']
